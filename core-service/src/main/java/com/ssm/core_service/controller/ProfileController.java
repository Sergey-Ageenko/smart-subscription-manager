...
public class ProfileController {
    ...
    public ResponseEntity<CoreResponse<ProfileResponse>> updateProfile(@AuthenticationPrincipal JwtUserPrincipal principal, @Valid @RequestBody ProfileUpdateRequest request) {
